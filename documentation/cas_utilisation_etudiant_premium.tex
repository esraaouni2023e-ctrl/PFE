...
Cette section présente la modélisation fonctionnelle et technique détaillée des 10 cas d'utilisation majeurs de l'étudiant. Les scénarios intègrent les aspects algorithmiques (moteur CAT 2PL, moteur IA SIAEPI v8.0) et les composants MVC correspondants.
...
% =========================================================================
% UC 03 : CONSULTER RECOMMANDATIONS (SIAEPI v8.0)
% =========================================================================
\subsection{Consulter les recommandations personnalisées}
\ucheader{UC-E03 : Consulter les recommandations de filières (SIAEPI v8.0)}{Étudiant}
