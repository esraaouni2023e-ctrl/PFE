    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .avatar-nav {
            ...
            background: linear-gradient(135deg, var(--accent2) 0%, var(--red) 100%);
            display: flex; align-items: center; justify-content: center;
...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            ...
            <li><a href="{{ route('admin.testimonials.index') }}" class="{{ request()->routeIs('admin.testimonials.*') ? 'active' : '' }}">Témoignages</a></li>
    ...
    <div class="mobile-nav" id="mobileNav">
        ...
        <div class="mobile-nav-drawer">
            ...
            <a href="{{ route('admin.testimonials.index') }}" class="{{ request()->routeIs('admin.testimonials.*') ? 'active' : '' }}">Témoignages</a>
