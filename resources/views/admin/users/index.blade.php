                                ...
                                @if(auth()->id() !== $user->id)
                                    <form action="{{ route('admin.users.block', $user) }}" method="POST" style="margin:0;">
                                        ...
                                        <button class="btn-glass" style="width:34px;height:34px;padding:0;border-radius:10px;font-size:0.9rem;{{ $user->is_blocked ? 'color:var(--red);border-color:rgba(220,53,69,0.3);background:rgba(220,53,69,0.05);' : '' }}" 
                                            ...
                                            @if($user->is_blocked)
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style="width:1rem;height:1rem;display:inline-block;vertical-align:middle;"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 10.5V6.75a4.5 4.5 0 119 0v3.75M3.75 21.75h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H3.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" /></svg>
                                            @else
