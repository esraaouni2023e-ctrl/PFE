...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="navbar-nav">
            ...
            <li><a href="{{ route('testimonial.edit') }}"     class="{{ request()->routeIs('testimonial.edit') ? 'active' : '' }}">Témoignage</a></li>
        </ul>
                ...
                <div class="avatar-nav" title="{{ auth()->user()?->name ?? 'Invité' }}" style="overflow:hidden;">
                    ...
                    @if($avatarUrl)
                        ...
                        <div style="position:relative;width:100%;height:100%;display:none;align-items:center;justify-content:center;">
                            ...
                            <span style="position:relative;z-index:2;text-shadow:0 1px 3px rgba(0,0,0,.2);">{{ strtoupper(substr(auth()->user()?->name ?? 'I', 0, 1)) }}</span>
                        </div>
                    @else
    ...
    <div class="mobile-nav" id="mobileNav">
        ...
        <div class="mobile-nav-drawer">
            ...
            <a href="{{ route('testimonial.edit') }}"     class="{{ request()->routeIs('testimonial.edit') ? 'active' : '' }}">Témoignage</a>
