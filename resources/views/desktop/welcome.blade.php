...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    .testi-carousel-card.featured {
      background: var(--accent);
      color: #fff;
      border-color: var(--accent);
    }
    .testi-carousel-card.featured .testi-quote,
    .testi-carousel-card.featured .testi-name {
      color: #fff;
    }
    .testi-carousel-card.featured .testi-role {
      color: rgba(255,255,255,0.75);
    }
    .testi-carousel-card.featured .testi-stars {
      color: #fff;
    }
  ...
  <section id="testimonials" class="section section-pad">
    <div class="container">
      ...
      @if(isset($testimonials) && $testimonials->count() > 0)
        <div class="testi-carousel-container reveal reveal-d1">
          <div class="testi-carousel-viewport">
            <div class="testi-carousel-track" id="carouselTrack">
              @foreach($testimonials as $index => $t)
                <div class="testi-carousel-card {{ $index % 3 === 0 ? 'featured' : '' }}">
                  <blockquote class="testi-quote" style="font-family: 'Fraunces', serif; font-size: 1.15rem; font-style: italic; line-height: 1.6; margin-bottom: 2rem;">
                    « {{ $t->comment }} »
                  </blockquote>
                  <div class="testi-author" style="margin-top: auto; display: flex; align-items: center; gap: 0.75rem;">
                    ...
                    @endif
                    <div>
                      <div class="testi-name" style="font-size: 0.88rem; font-weight: 700; color: inherit;">{{ $t->user?->name ?? 'Anonyme' }}</div>
                      <div class="testi-role" style="font-size: 0.78rem; opacity: 0.75; margin-top: 0.15rem;">
                      ...
                      <div class="testi-stars" style="font-size: 0.8rem; margin-top: 0.2rem; color: {{ $index % 3 === 0 ? '#fff' : 'var(--gold)' }};">
          ...
          @if($testimonials->count() > 1)
            <div class="testi-carousel-controls">
              <button class="testi-carousel-btn" id="prevBtn" title="Précédent">←</button>
              <button class="testi-carousel-btn" id="nextBtn" title="Suivant">→</button>
            </div>
          @endif
        </div>
      @else
        {{-- Fallback: Static Premium Testimonials if no reviews in DB --}}
        <div class="testi-featured">
          <div class="testi-big reveal reveal-d1">
            ...
            <div class="testi-author">
              <div class="testi-ava" style="width: 44px; height: 44px; border-radius: 50%; background: rgba(255, 255, 255, .25); display: flex; align-items: center; justify-content: center; font-family: 'Fraunces', serif; font-size: 1rem; font-weight: 600; color: #fff; flex-shrink: 0;">E</div>
              <div>
          ...
          <div class="testi-small reveal reveal-d2">
            ...
            <div class="testi-author" style="margin-top:1.5rem;display:flex;align-items:center;gap:.75rem;">
              <div class="testi-ava" style="width: 44px; height: 44px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-family: 'Fraunces', serif; font-size: 1rem; font-weight: 600; flex-shrink: 0; background:var(--ink10);color:var(--ink);">S</div>
              <div>
          ...
          <div class="testi-small reveal reveal-d3">
            ...
            <div class="testi-author" style="margin-top:1.5rem;display:flex;align-items:center;gap:.75rem;">
              <div class="testi-ava" style="width: 44px; height: 44px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-family: 'Fraunces', serif; font-size: 1rem; font-weight: 600; flex-shrink: 0; background:var(--ink10);color:var(--ink);">Y</div>
              <div>
          ...
          <div class="testi-small reveal reveal-d2">
            ...
            <div class="testi-author" style="margin-top:1.5rem;display:flex;align-items:center;gap:.75rem;">
              <div class="testi-ava" style="width: 44px; height: 44px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-family: 'Fraunces', serif; font-size: 1rem; font-weight: 600; flex-shrink: 0; background:var(--ink10);color:var(--ink);">K</div>
              <div>
  ...
  <script>
    ...
    if (track && prevBtn && nextBtn) {
      ...
      function getSlideWidth() {
        const card = track.querySelector('.testi-carousel-card');
        if (!card) return 0;
      ...
      function getMaxIndex() {
        const cards = track.querySelectorAll('.testi-carousel-card');
        let visibleCards = 3;
      ...
      // Initialize layout buttons state
      updateCarousel();
    }
