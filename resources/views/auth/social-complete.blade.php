<x-auth-layout>
    @section('page-title', 'Finaliser l\'inscription')

    {{-- Header --}}
    <div style="margin-bottom: 2rem; text-align: center;">
        <h2 class="heading-3 mb-2">
            Finaliser votre <em class="text-gradient">inscription</em>
        </h2>
        <p class="body-small">Connecté via {{ ucfirst($socialData['provider']) }} ({{ $socialData['email'] }}). Saisissez un mot de passe pour sécuriser votre compte.</p>
    </div>

    {{-- Completion Form --}}
    <form method="POST" action="{{ url('auth/social/complete') }}" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 1.5rem;">
        @csrf
        ...
        <div>
            ...
            <div class="relative group">
                <div style="position: absolute; top: 50%; left: 1rem; transform: translateY(-50%); color: var(--ink30); pointer-events: none; transition: color 0.2s; z-index: 2;">
                ...
                <button type="button" class="toggle-password" data-target="password" style="position: absolute; top: 50%; right: 1rem; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: var(--ink30); display: flex; align-items: center; z-index: 2;">
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password"
                    class="input-2026" style="padding-left: 3rem; padding-right: 3rem;" placeholder="••••••••">
                <button type="button" class="toggle-password" data-target="password_confirmation" style="position: absolute; top: 50%; right: 1rem; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: var(--ink30); display: flex; align-items: center; z-index: 2;">
                    <svg class="eye-icon" style="width: 1.2rem; height: 1.2rem;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                    </svg>
                </button>
        ...
        <div id="counselor-extra-fields" style="display: none; flex-direction: column; gap: 1.5rem; padding-top: 1.5rem; margin-top: 0.5rem; overflow: hidden; transition: max-height 0.5s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.4s ease; max-height: 0; opacity: 0;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                ...
                <div>
                    ...
                    <div class="relative group">
                        <div style="position: absolute; top: 50%; left: 1rem; transform: translateY(-50%); color: var(--ink30); pointer-events: none; z-index: 2;">
            ...
            <div>
                ...
                <div class="relative group">
                    <div style="position: absolute; top: 1rem; left: 1rem; color: var(--ink30); pointer-events: none; z-index: 2;">
                        <svg style="width: 1.1rem; height: 1.1rem;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
