...
@section('content')
<style>
:root{--ink:#1E293B;--paper:#FFFFFF;--cream:#F8FAFC;--warm:#E2E8F0;--accent:#EA580C;--accent2:#0A2540;--accent3:#F97316;--gold:#F97316;--ink60:rgba(30,41,59,.6);--ink30:rgba(30,41,59,.3);--ink15:rgba(30,41,59,.15);--ink10:rgba(30,41,59,.15);--ink06:rgba(30,41,59,.06);--r:8px;--rl:16px;--rx:999px;--ease:cubic-bezier(.16,1,.3,1)}
