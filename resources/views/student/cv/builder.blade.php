...
<div class="builder-page" x-data="cvBuilder()">
    <div class="builder-header">
        <h1>{!! $cvProfile ? '<i class="bi bi-pencil-square" style="margin-right:.4rem;vertical-align:middle;"></i> Modifier' : '<i class="bi bi-file-earmark-plus" style="margin-right:.4rem;vertical-align:middle;"></i> Créer' !!} un CV</h1>
