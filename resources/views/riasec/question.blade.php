...
<div class="q-page" x-data="riasecQ()" x-init="init()">
    ...
    <div class="q-card">
        ...
        @php
        $dimBadge = [
            'R'=>['color'=>'#FF6A00','bg'=>'rgba(255,106,0,.1)','label'=>'Réaliste','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>'],
            'I'=>['color'=>'#0057B8','bg'=>'rgba(0,87,184,.1)','label'=>'Investigateur','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m16 16-3.5-3.5"/><circle cx="11" cy="11" r="4"/></svg>'],
            'A'=>['color'=>'#FF8C1A','bg'=>'rgba(255,140,26,.1)','label'=>'Artistique','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10Zm0-13a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="m19 12-5 5"/></svg>'],
            'S'=>['color'=>'#003B8E','bg'=>'rgba(0,59,142,.1)','label'=>'Social','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>'],
    ...
    <div class="q-card" style="padding:1.2rem 1.5rem;">
        ...
        <div class="dim-mini-grid">
            @php
            $dimColors2 = ['R'=>'#FF6A00','I'=>'#0057B8','A'=>'#FF8C1A','S'=>'#003B8E','E'=>'#7c4a7c','C'=>'#4a6e6e'];
            $dimIcon2  = [
