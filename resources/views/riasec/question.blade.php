...
<div class="q-page" x-data="riasecQ({{ $isLast ? 'true' : 'false' }})" x-init="init()">
    ...
    <div class="q-card">
        ...
        @php
        $dimBadge = [
            'R'=>['color'=>'#EA580C','bg'=>'rgba(234,88,12,.1)','label'=>'Réaliste','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>'],
            'I'=>['color'=>'#2563EB','bg'=>'rgba(37,99,235,.1)','label'=>'Investigateur','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m16 16-3.5-3.5"/><circle cx="11" cy="11" r="4"/></svg>'],
            'A'=>['color'=>'#F59E0B','bg'=>'rgba(245,158,11,.1)','label'=>'Artistique','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10Zm0-13a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/><path d="m19 12-5 5"/></svg>'],
            'S'=>['color'=>'#10B981','bg'=>'rgba(16,185,129,.1)','label'=>'Social','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>'],
            'E'=>['color'=>'#8B5CF6','bg'=>'rgba(139,92,246,.1)','label'=>'Entreprenant','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m3 21 1.9-5.7a8.5 8.5 0 1 1 14.2 0L21 21Z"/><path d="M9 12h6"/><path d="M12 9v6"/></svg>'],
            'C'=>['color'=>'#0D9488','bg'=>'rgba(13,148,136,.1)','label'=>'Conventionnel','icon'=>'<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M8 7h8"/><path d="M8 12h8"/><path d="M8 17h8"/></svg>'],
        ];
    ...
    <div class="q-card" style="padding:1.2rem 1.5rem;">
        ...
        <div class="dim-mini-grid">
            @php
            $dimColors2 = ['R'=>'#EA580C','I'=>'#2563EB','A'=>'#F59E0B','S'=>'#10B981','E'=>'#8B5CF6','C'=>'#0D9488'];
            $dimIcon2  = [
